    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Shababul Alam</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01631613033</h4>
		<h4 style="font-family:'typo' ">sababul37@gmail.com</h4>
		<h4 style="font-family:'typo' ">Wev developer,Dhaka</h4></div></div>
		</p>
      </div>
    </div>
  </div>
