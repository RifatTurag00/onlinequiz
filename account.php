  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/pic.jpg" width=100 height=100 alt="Arpita" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Arpita Ghose</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01641949854</h4>
		<h4 style="font-family:'typo' ">arpita@gmail.com</h4>
		<h4 style="font-family:'typo' ">Web Developer ,Dhaka</h4></div></div>
		</p>
      </div>
